...
//     ft::vector<int>::const_iterator it = ftVector.rbegin();
...
//     assert(*it == 1, "Rbegin iterator points to the correct element");
//     test_begin_by_reference(ftVector, 1);
// }

// static void test_rend_by_reference(const ft::vector<int> &ftVector, int expectedValue) {
//     ft::vector<int>::const_iterator it = ftVector.begin();
...
//     ft::vector<int>::iterator it = ftVector.rend();

//     assert(it == ftVector.begin() + ftVector.size(), "Rend iterator points to the correct element");
//     test_end_by_reference(ftVector, 1);
// }
