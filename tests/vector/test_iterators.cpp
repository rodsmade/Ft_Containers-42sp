...
static void test_end_by_reference(const ft::vector<int> &ftVector, int lastValue) {
    ...
    my_assert(it == (ftVector.begin() + ftVector.size()), "End const_iterator points to the correct element (test by reference)");
    my_assert(*(it - 1) == lastValue, "Last element of vector accessed via end()");
}
...
static void test_end() {
    ...
    my_assert(it == (ftVector.begin() + ftVector.size()), "End iterator points to the correct element");
...
static void test_rbegin_by_reference(const ft::vector<int> &ftVector, int expectedValue) {
    ...
    my_assert(*it == expectedValue, "Rbegin const_iterator points to the correct element (test by reference)");
}
...
static void test_rbegin() {
    ...
    my_assert(*it == 5, "Rbegin iterator points to the correct element");
...
static void test_rend_by_reference(const ft::vector<int> &ftVector, int lastValue) {
    ...
    my_assert(it == (ftVector.rbegin() + ftVector.size()), "Rend const_iterator points to the correct element (test by reference)");
    my_assert(*(it - 1) == lastValue, "Last element of vector accessed via rend()");
}
...
static void test_rend() {
    ...
    my_assert(it == ftVector.rbegin() + ftVector.size(), "Rend iterator points to the correct element");
